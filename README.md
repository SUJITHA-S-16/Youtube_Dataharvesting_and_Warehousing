...
1.	  Ability to input a YouTube channel ID and retrieve all the relevant data (Channel name, subscribers, total video count, playlist ID, video ID, likes, dislikes, comments of each video) using Google 
2.	To search and retrieve data from the SQL database using API.
...
6.	Ability different search options, including joining tables to get channel details.
